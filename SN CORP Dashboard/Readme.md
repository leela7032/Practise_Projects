...
![Dashboard Screenshot](https://github.com/leela7032/Practise_Projects/raw/main/SN%20CORP%20Dashboard/SN%20Corp%20Dashboard.png)
...
I’ve analyzed the problem and followed the AMES Grid (4 Steps):

1. **What is the Purpose?**  
   Unlock hidden sales insights for decision-making and reduce manual effort.

2. **Who are the Stakeholders?**  
   Sales Director, Marketing Team, Customer Service, Analytics, and IT teams.

3. **What is the End Result?**  
   Build an automated dashboard for quick, reliable sales insights.

4. **Success Criteria**  
   Save 70% manual time through automation and improved data accessibility.
